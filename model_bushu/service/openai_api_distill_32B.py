...
def parse_args():
    ...
    parser.add_argument("--port", type=int, default=8509, help="port number")
    parser.add_argument(
        "--uvicorn-log-level",
        type=str,
        default="info",
...
if __name__ == "__main__":
    args = parse_args()
    args.model = '/DATA/LLM_model/deepseek/DeepSeek-R1-Distill-Qwen-32B'
    args.served_model_name = 'DeepSeek-R1-Distill-Qwen-32B'
    args.gpu_memory_utilization = 0.93
